...
def comment_delete(request, id):
    ...
    if obj.user != request.user:
        # messages.info(request, "You do not have permission to delete this comment!")
        # raise Http404
    ...
    if request.method == "POST":
        ...
        obj.delete()
        messages.success(request, "This comment has been deleted successfully!")
...
def comment_thread(request, id):
    ...
    if not obj.is_parent:
        obj = obj.parent
    # content_object = obj.content_object  # Get the Post that the comment is on
